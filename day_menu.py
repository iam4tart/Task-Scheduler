...
class day_menu(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.wave = ImageTk.PhotoImage(Image.open("assets/Header/day_header.png")) 
        ...
        #  All added tasks
        self.data_dir = []
        self.var = (db.show_tasks("DAY"))
        for i in range(len(self.var)):
            self.data_dir.append([self.var[i]['title'], self.var[i]['time'], self.var[i]['refID'], self.var[i]['completion']])
